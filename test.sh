...
echo -e "    Constant-time modular multiplier and reducer (tested + formally proven)"
...
echo -e "    This core:    single-word (32-bit) constant-time modular squaring, formally verified"
